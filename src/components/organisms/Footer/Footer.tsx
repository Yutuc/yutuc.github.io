...
export default function Footer({}: AppHeaderProps) {
  ...
  return (
    <div className="w-full h-1/4 bg-secondaryBlue mt-5">
      ...
      <div className="flex justify-center md:text-xl sm:text-lg">
        <h1 className="text-secondaryBlue font-bold text-white">
          health101services@gmail.com
        </h1>
      </div>
      <div className="flex justify-center md:text-xl sm:text-lg text-white m-2">
        <svg
          onClick={openFB}
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7 mx-5 my-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div className="flex justify-center md:text-lg sm:text-lg">
        <h1 className="text-secondaryBlue font-bold text-white">H101 © 2023</h1>
      </div>
    </div>
  );
}
